...
if(isset($_POST['id_fuente_hidrica']) && isset($_POST['id_fuente_hidrica']) != "")
{
	...
	$query3 = "DELETE FROM wintig.muestra WHERE id_muestra = '$fh_id'";
	$query4 = "DELETE FROM wintig.ica WHERE id_ica = '$fh_id'";
	$query5 = "DELETE FROM wintig.irca WHERE id_irca = '$fh_id'";
	$query6 = "DELETE FROM wintig.uso WHERE id_uso = '$fh_id'";
	pg_query($conexion,$query1);
	pg_query($conexion,$query2);
	pg_query($conexion,$query3);
	pg_query($conexion,$query4);
	pg_query($conexion,$query5);
	pg_query($conexion,$query6);
}
?>