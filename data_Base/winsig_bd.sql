...
create schema if not exists winsig;
  ...
  create table if not exists winsig.rancheria (
  ...
  alter table winsig.fuente_hidrica add constraint fuente_hidrica_rancheria_fk foreign key (id_rancheria) references winsig.rancheria (id_rancheria);
  ...
  INSERT INTO winsig.rancheria (nom_rancheria, cantidad_personas, representante) VALUES ('rancheria-test1', 14, 'Martina');

  INSERT INTO winsig.fuente_hidrica (id_tipo_fuente_hidrica) VALUES (1);
